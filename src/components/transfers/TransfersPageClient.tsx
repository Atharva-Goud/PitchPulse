...
export default function TransfersPageClient({ initialData }: TransfersPageClientProps) {
  const { rumours: initialRumours, confirmed: initialConfirmed, statusFilters } = initialData;
  const [rumours, setRumours] = useState<Transfer[]>(initialRumours);
  const [confirmed, setConfirmed] = useState<Transfer[]>(initialConfirmed);
